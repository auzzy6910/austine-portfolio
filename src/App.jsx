...
import { Upload, Trash2, X, ChevronLeft, ChevronRight, Palette, PenTool, Layout, Image, Mail, MapPin, Phone, Instagram, Twitter, Linkedin, Github, Menu } from 'lucide-react'
    ...
    <>
      ...
      <section className="hero-section" id="home">
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <motion.div className="hero-stats" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }}>
      ...
      <section className="section" id="about">
        ...
        <div className="about-content">
          <motion.div className="about-image-container" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <img src={profileImg} alt="Austine" className="about-image" />
            <div className="about-image-accent" />
          </motion.div>
          <motion.div className="about-text" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <section className="section" id="portfolio">
        ...
        <div className="upload-area" onClick={() => fileInputRef.current?.click()}>
          ...
          <p>Click or drag and drop your design files here</p>
      ...
      <AnimatePresence>
        {showUploadModal && (
          <motion.div className="upload-modal-overlay" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div className="upload-modal" initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.8, opacity: 0 }}
              onClick={e => e.stopPropagation()}>
              <button className="modal-close-btn" onClick={() => setShowUploadModal(false)}><X size={24} /></button>
              <h2>Upload Work</h2>
              {uploadData.preview && <img src={uploadData.preview} alt="Preview" className="upload-preview" />}
              ...
              <div className="upload-modal-actions">
                <button className="btn-primary" onClick={handleUpload} style={{ flex: 1 }}>Upload</button>
                <button className="btn-outline" onClick={() => setShowUploadModal(false)} style={{ flex: 1 }}>Cancel</button>
              </div>
            </motion.div>
          </motion.div>
        )}
      ...
      <AnimatePresence>
        {deleteConfirm !== null && (
          <motion.div className="delete-confirm-overlay" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div className="delete-confirm-modal" initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }}
              onClick={e => e.stopPropagation()}>
              <h3>Delete Work?</h3>
              <p>Are you sure you want to remove this work from your portfolio? This action cannot be undone.</p>
              <div className="delete-confirm-actions">
                <button className="btn-primary" onClick={() => handleDelete(deleteConfirm)}>Delete</button>
      ...
      <section className="section" id="contact">
        ...
        <div className="contact-content">
          <motion.div className="contact-info" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <motion.form className="contact-form" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
        ...
        <div className="footer-content">
          <div className="footer-socials">
            {[Instagram, Twitter, Linkedin, Github].map((Icon, i) => (
              <a key={i} href="#" className="footer-social-link"><Icon size={20} /></a>
            ))}
          </div>
